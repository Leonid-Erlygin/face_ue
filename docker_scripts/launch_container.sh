...
docker run -d --shm-size=8g --memory=80g --gpus '"device=0,1,2"' --user 4200214:4200214 --name kolesnikov_face_eval_new --rm -it --init -v $HOME/face_ue:/app ikolesnikov-face bash
